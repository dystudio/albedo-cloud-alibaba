<template>
  <div class="app-container calendar-list-container">
    ...
    <div class="filter-container">
      <el-form :inline="true"  :model="searchTestBookForm" ref="searchTestBookForm" v-show="searchFilterVisible">
        <el-form-item label="标题" prop="title">
          <el-input class="filter-item input-normal" v-model="searchTestBookForm.title"></el-input>
        </el-form-item>
        <el-form-item label="名称" prop="name">
          <el-input class="filter-item input-normal" v-model="searchTestBookForm.name"></el-input>
        </el-form-item>
        <el-form-item>
...
export default {
  ...
  methods: {
    getList() {
      ...
      {fieldName: 'title',value:this.searchTestBookForm.title,operate:'like',attrType:'String'},
      {fieldName: 'name',value:this.searchTestBookForm.name,operate:'like',attrType:'String'},
      ])
      testBookService.page(this.listQuery).then(response => {
    ...
    handleEdit(row) {
      ...
      if(this.dialogStatus == "create"){
        ...
        testBookService.find(row.id).then(response => {
            this.form = response.data;
            this.form.delFlag=validate.objectToString(this.form.delFlag);
            this.dialogFormVisible = true;
          });
      }
    },
    ...
    save() {
      ...
      set['form'].validate(valid => {
        if (valid) {
          testBookService.save(this.form).then((data) => {
            this.getList();
            this.cancel()
          });
        } else {
    ...
    handleDelete(row) {
      this.$confirm(
        ...
        testBookService.remove(row.id).then((data) => {
            this.getList();
          });
      });
    },
